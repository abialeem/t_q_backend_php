...
//Get All videos of a single course_id
public function getSingleCourseVideos()
{
    $query = 'SELECT 
    *
    FROM ' . $this->table . ' 
...
//Get All videos of a single subject_id
public function getSingleSubjectVideos()
{
    $query = 'SELECT 
    *
    FROM ' . $this->table . ' 
...
//Get All videos of a single topic_id
public function getSingleTopicVideos()
{
    $query = 'SELECT 
    *
    FROM ' . $this->table . ' 
...
// GET SINGLE Video Title BY ID
public function getSingleVideoTitleById()
{
    $query = 'SELECT 
                title
                FROM ' . $this->table . ' 
...
//get serial no's of videos of topic by topic id
public function getAllVideosSerialsByTopicID(){
