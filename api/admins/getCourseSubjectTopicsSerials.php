...
if (isset($course_id) && isset($subject_id)) {
    if( (empty($course_id) or $course_id == '0') && (empty($subject_id) or $subject_id == '0') ) {
...
$result = $topic->getAllTopicsSerialsByCourseIDSubjectID();
